...
import Omini.process_manager.process_manager as HostManager
import Omini.applications.Openocd as Openocd
import Omini.applications.Salea as SaleaBackend
